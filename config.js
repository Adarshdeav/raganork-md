...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'desss;deavo;0;https://cdn.ironman.my.id/i/22hekx.jpeg',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "deavo",
    BOT_NAME: process.env.BOT_NAME || 'dessa',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'deavo;dessa;https://cdn.ironman.my.id/i/22hekx.jpeg' : process.env.AUDIO_DATA,
